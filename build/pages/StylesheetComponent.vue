<template>
    <div class="container py-5">
        ...
        <h2 class="pt-3 pb-1">Palette</h2>

        <div class="row">
            <div class="col-sm">
                <div class="card mb-3">
                    <div class="card-body">
                        <img src="/js/holder/holder.js/512x256?bg=2A72FF&text=#2A72FF" class="img-fluid" alt="Blue palette image tile">
            ...
            <div class="col-sm">
                <div class="card mb-3">
                    <div class="card-body">
                        <img src="/js/holder/holder.js/512x256?bg=6500F2&text=#6500F2" class="img-fluid" alt="Indigo palette image tile">
                        <h3 class="text-center">Indigo</h3>
                    </div>
                </div>
            </div>
            <div class="col-sm">
                <div class="card mb-3">
                    <div class="card-body">
                        <img src="/js/holder/holder.js/512x256?bg=6D3AC0&text=#6D3AC0" class="img-fluid" alt="Purple palette image tile">
                        <h3 class="text-center">Purple</h3>
                    </div>
                </div>
            </div>
            <div class="col-sm">
                <div class="card mb-3">
                    <div class="card-body">
                        <img src="/js/holder/holder.js/512x256?bg=E13D8D&text=#E13D8D" class="img-fluid" alt="Pink palette image tile">
        ...
        <div class="row">
            <div class="col-sm">
                <div class="card mb-3">
                    <div class="card-body">
                        <img src="/js/holder/holder.js/512x256?bg=D5384A&text=#D5384A" class="img-fluid" alt="Red palette image tile">
            ...
            <div class="col-sm">
                <div class="card mb-3">
                    <div class="card-body">
                        <img src="/js/holder/holder.js/512x256?bg=F77F24&text=#F77F24" class="img-fluid" alt="Orange palette image tile">
            ...
            <div class="col-sm">
                <div class="card mb-3">
                    <div class="card-body">
                        <img src="/js/holder/holder.js/512x256?bg=FBC314&text=#FBC314" class="img-fluid" alt="Yellow palette image tile">
            ...
            <div class="col-sm">
                <div class="card mb-3">
                    <div class="card-body">
                        <img src="/js/holder/holder.js/512x256?bg=3DA744&text=#3DA744" class="img-fluid" alt="Green palette image tile">
        ...
        <div class="row">
            <div class="col-sm">
                <div class="card mb-3">
                    <div class="card-body">
                        <img src="/js/holder/holder.js/512x256?bg=42C994&text=#42C994" class="img-fluid" alt="Teal palette image tile">
                        <h3 class="text-center">Teal</h3>
                    </div>
                </div>
            </div>
            <div class="col-sm">
                <div class="card mb-3">
                    <div class="card-body">
                        <img src="/js/holder/holder.js/512x256?bg=36A0B6&text=#36A0B6" class="img-fluid" alt="Cyan palette image tile">
                        <h3 class="text-center">Cyan</h3>
                    </div>
                </div>
            </div>
            <div class="col-sm">
                <div class="card mb-3">
                    <div class="card-body">
                        <img src="/js/holder/holder.js/512x256?bg=858C95&text=#858C95" class="img-fluid" alt="Gray palette image tile">
                        <h3 class="text-center">Gray</h3>
                    </div>
                </div>
            </div>
            <div class="col-sm">
                <div class="card mb-3">
                    <div class="card-body">
                        <img src="/js/holder/holder.js/512x256?bg=383C42&text=#383C42" class="img-fluid" alt="Dark Gray palette image tile">
                        <h3 class="text-center">Dark Gray</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <img data-src="/js/holder/holder.js/200x200" class="img-thumbnail" alt="A generic square placeholder image with a white border around it, making it resemble a photograph taken with an old instant camera">
        ...
        <h2 class="pt-3 pb-1">Carousel</h2>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="/js/holder/holder.js/1140x500/auto/#AAA:#555/text:First slide" alt="First slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="/js/holder/holder.js/1140x500/auto/#AAA:#444/text:Second slide" alt="Second slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block w-100" src="/js/holder/holder.js/1140x500/auto/#AAA:#333/text:Third slide" alt="Third slide">
                </div>
            </div>
...
<script>
    export default {
        name: 'stylesheet-component',
        data() {
            return {}
        },
        methods: {},
        mounted() {
            console.log('Stylesheet Component mounted.');
        }
    }
</script>
